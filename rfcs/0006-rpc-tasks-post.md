...
- Author(s): Rentably
- Status: accepted (part of v0.1); settlement-related portions amended at v0.955 (see `spec/0.955.md` — the descriptor's `settlement` block and the escrow-hold step are removed; new optional fields `max_attestation_attempts` and `accounting_ref` apply).
