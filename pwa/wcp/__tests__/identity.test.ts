...
import { canonicalJsonStringify } from "../identity";
...
describe("canonicalJsonStringify", () => {
  ...
  it("nests objects with sorted keys", () => {
  ...
  it("matches Python json.dumps(sort_keys=True, separators) for a representative payload", () => {
    const payload = {
      claim_id: "c1",
    ...
    // The Python backend signs over this exact canonical form.
