...
WCP worker scaffold for **maritime and subsea operations**.

Class: `{{CLASS}}`. Domain template: `maritime`.

## What WCP does for this domain

The Worker Context Protocol coordinates AI agents and physical-world workers
across a broad set of institutional domains. This template is for **maritime and subsea operations**.
Typical use cases include: ROV inspection runs, buoy maintenance, hull surveys, supply transfers.

Adjacent domains served by the same protocol include research, infrastructure. See the full
