...
WCP worker scaffold for **scientific lab operations**.

Class: `{{CLASS}}`. Domain template: `scientific`.

## What WCP does for this domain

The Worker Context Protocol coordinates AI agents and physical-world workers
across a broad set of institutional domains. This template is for **scientific lab operations**.
Typical use cases include: instrument calibration scheduling, sample preparation queues, autonomous experiment runners.

Adjacent domains served by the same protocol include research, healthcare. See the full
